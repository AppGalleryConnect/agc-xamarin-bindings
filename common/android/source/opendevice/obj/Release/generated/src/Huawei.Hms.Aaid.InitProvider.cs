...
namespace Huawei.Hms.Aaid {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.huawei.hms.aaid']/class[@name='InitProvider']"
	[global::Android.Runtime.Register ("com/huawei/hms/aaid/InitProvider", DoNotGenerateAcw=true)]
	public partial class InitProvider : global::Android.Content.ContentProvider {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/huawei/hms/aaid/InitProvider", typeof (InitProvider));
		...
		protected InitProvider (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.huawei.hms.aaid']/class[@name='InitProvider']/constructor[@name='InitProvider' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe InitProvider ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Huawei.Hms.Aaid.InitProvider> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.aaid']/class[@name='InitProvider']/method[@name='delete' and count(parameter)=3 and parameter[1][@type='android.net.Uri'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.aaid']/class[@name='InitProvider']/method[@name='getType' and count(parameter)=1 and parameter[1][@type='android.net.Uri']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.aaid']/class[@name='InitProvider']/method[@name='insert' and count(parameter)=2 and parameter[1][@type='android.net.Uri'] and parameter[2][@type='android.content.ContentValues']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.aaid']/class[@name='InitProvider']/method[@name='onCreate' and count(parameter)=0]"
