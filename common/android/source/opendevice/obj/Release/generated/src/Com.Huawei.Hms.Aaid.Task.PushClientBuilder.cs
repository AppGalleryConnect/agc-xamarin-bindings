...
namespace Com.Huawei.Hms.Aaid.Task {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.huawei.hms.aaid.task']/class[@name='PushClientBuilder']"
	[global::Android.Runtime.Register ("com/huawei/hms/aaid/task/PushClientBuilder", DoNotGenerateAcw=true)]
	public partial class PushClientBuilder : global::Huawei.Hms.Common.Internal.AbstractClientBuilder {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/huawei/hms/aaid/task/PushClientBuilder", typeof (PushClientBuilder));
		...
		protected PushClientBuilder (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.huawei.hms.aaid.task']/class[@name='PushClientBuilder']/constructor[@name='PushClientBuilder' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe PushClientBuilder ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Huawei.Hms.Aaid.Task.PushClientBuilder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.aaid.task']/class[@name='PushClientBuilder']/method[@name='buildClient' and count(parameter)=4 and parameter[1][@type='android.content.Context'] and parameter[2][@type='com.huawei.hms.common.internal.ClientSettings'] and parameter[3][@type='com.huawei.hms.common.internal.BaseHmsClient.OnConnectionFailedListener'] and parameter[4][@type='com.huawei.hms.common.internal.BaseHmsClient.ConnectionCallbacks']]"
		[Register ("buildClient", "(Landroid/content/Context;Lcom/huawei/hms/common/internal/ClientSettings;Lcom/huawei/hms/common/internal/BaseHmsClient$OnConnectionFailedListener;Lcom/huawei/hms/common/internal/BaseHmsClient$ConnectionCallbacks;)Lcom/huawei/hms/aaid/task/PushClient;", "GetBuildClient_Landroid_content_Context_Lcom_huawei_hms_common_internal_ClientSettings_Lcom_huawei_hms_common_internal_BaseHmsClient_OnConnectionFailedListener_Lcom_huawei_hms_common_internal_BaseHmsClient_ConnectionCallbacks_Handler")]
		public virtual unsafe global::Com.Huawei.Hms.Aaid.Task.PushClient BuildClient (global::Android.Content.Context p0, global::Huawei.Hms.Common.Internal.ClientSettings p1, global::Huawei.Hms.Common.Internal.BaseHmsClient.IOnConnectionFailedListener p2, global::Huawei.Hms.Common.Internal.BaseHmsClient.IConnectionCallbacks p3)
		{
			const string __id = "buildClient.(Landroid/content/Context;Lcom/huawei/hms/common/internal/ClientSettings;Lcom/huawei/hms/common/internal/BaseHmsClient$OnConnectionFailedListener;Lcom/huawei/hms/common/internal/BaseHmsClient$ConnectionCallbacks;)Lcom/huawei/hms/aaid/task/PushClient;";
			try {
				...
				return global::Java.Lang.Object.GetObject<global::Com.Huawei.Hms.Aaid.Task.PushClient> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
