...
namespace Huawei.Hms.Update.Provider {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']"
	[global::Android.Runtime.Register ("com/huawei/hms/update/provider/UpdateProvider", DoNotGenerateAcw=true)]
	public partial class UpdateProvider : global::Android.Content.ContentProvider {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/field[@name='AUTHORITIES_SUFFIX']"
		[Register ("AUTHORITIES_SUFFIX")]
		public const string AuthoritiesSuffix = (string) ".hms.update.provider";
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/huawei/hms/update/provider/UpdateProvider", typeof (UpdateProvider));
		...
		protected UpdateProvider (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/constructor[@name='UpdateProvider' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe UpdateProvider ()
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='a' and count(parameter)=2 and parameter[1][@type='java.lang.Object[]'] and parameter[2][@type='int']]"
		[Register ("a", "([Ljava/lang/Object;I)[Ljava/lang/Object;", "")]
		public static unsafe global::Java.Lang.Object[] A (global::Java.Lang.Object[] p0, int p1)
		{
			const string __id = "a.([Ljava/lang/Object;I)[Ljava/lang/Object;";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='a' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("a", "(Ljava/lang/String;)I", "")]
		public static unsafe int A (string p0)
		{
			const string __id = "a.(Ljava/lang/String;)I";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='a' and count(parameter)=2 and parameter[1][@type='java.lang.String[]'] and parameter[2][@type='int']]"
		[Register ("a", "([Ljava/lang/String;I)[Ljava/lang/String;", "")]
		public static unsafe string[] A (string[] p0, int p1)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Huawei.Hms.Update.Provider.UpdateProvider> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='delete' and count(parameter)=3 and parameter[1][@type='android.net.Uri'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String[]']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='getLocalFile' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String']]"
		[Register ("getLocalFile", "(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;", "")]
		public static unsafe global::Java.IO.File GetLocalFile (global::Android.Content.Context p0, string p1)
		{
			const string __id = "getLocalFile.(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;";
			IntPtr native_p1 = JNIEnv.NewString (p1);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='getType' and count(parameter)=1 and parameter[1][@type='android.net.Uri']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='getUriForFile' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.io.File']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='insert' and count(parameter)=2 and parameter[1][@type='android.net.Uri'] and parameter[2][@type='android.content.ContentValues']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='onCreate' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='query' and count(parameter)=5 and parameter[1][@type='android.net.Uri'] and parameter[2][@type='java.lang.String[]'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String[]'] and parameter[5][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.update.provider']/class[@name='UpdateProvider']/method[@name='update' and count(parameter)=4 and parameter[1][@type='android.net.Uri'] and parameter[2][@type='android.content.ContentValues'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String[]']]"
