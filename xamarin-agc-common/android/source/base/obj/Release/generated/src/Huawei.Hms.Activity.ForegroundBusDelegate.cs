...
namespace Huawei.Hms.Activity {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']"
	[global::Android.Runtime.Register ("com/huawei/hms/activity/ForegroundBusDelegate", DoNotGenerateAcw=true)]
	public partial class ForegroundBusDelegate : global::Java.Lang.Object, global::Huawei.Hms.Activity.IBridgeActivityDelegate {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/field[@name='HMS_FOREGROUND_REQ_BODY']"
		[Register ("HMS_FOREGROUND_REQ_BODY")]
		public const string HmsForegroundReqBody = (string) "HMS_FOREGROUND_REQ_BODY";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/field[@name='HMS_FOREGROUND_REQ_HEADER']"
		[Register ("HMS_FOREGROUND_REQ_HEADER")]
		public const string HmsForegroundReqHeader = (string) "HMS_FOREGROUND_REQ_HEADER";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/field[@name='HMS_FOREGROUND_REQ_INNER']"
		[Register ("HMS_FOREGROUND_REQ_INNER")]
		public const string HmsForegroundReqInner = (string) "HMS_FOREGROUND_REQ_INNER";

		// Metadata.xml XPath field reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/field[@name='HMS_FOREGROUND_RESP_HEADER']"
		[Register ("HMS_FOREGROUND_RESP_HEADER")]
		public const string HmsForegroundRespHeader = (string) "HMS_FOREGROUND_RESP_HEADER";
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/huawei/hms/activity/ForegroundBusDelegate", typeof (ForegroundBusDelegate));
		...
		protected ForegroundBusDelegate (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/constructor[@name='ForegroundBusDelegate' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ForegroundBusDelegate ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Huawei.Hms.Activity.ForegroundBusDelegate> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.RequestCode;
		}
#pragma warning restore 0169

		public virtual unsafe int RequestCode {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/method[@name='getRequestCode' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/method[@name='onBridgeActivityCreate' and count(parameter)=1 and parameter[1][@type='android.app.Activity']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/method[@name='onBridgeActivityDestroy' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/method[@name='onBridgeActivityResult' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='android.content.Intent']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/method[@name='onBridgeConfigurationChanged' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.activity']/class[@name='ForegroundBusDelegate']/method[@name='onKeyUp' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='android.view.KeyEvent']]"
