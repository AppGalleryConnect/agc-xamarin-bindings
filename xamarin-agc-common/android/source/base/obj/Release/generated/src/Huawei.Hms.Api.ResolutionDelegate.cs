...
namespace Huawei.Hms.Api {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']"
	[global::Android.Runtime.Register ("com/huawei/hms/api/ResolutionDelegate", DoNotGenerateAcw=true)]
	public partial class ResolutionDelegate : global::Java.Lang.Object, global::Huawei.Hms.Activity.IBridgeActivityDelegate {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/field[@name='CALLBACK_METHOD']"
		[Register ("CALLBACK_METHOD")]
		public const string CallbackMethod = (string) "CALLBACK_METHOD";
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/huawei/hms/api/ResolutionDelegate", typeof (ResolutionDelegate));
		...
		protected ResolutionDelegate (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/constructor[@name='ResolutionDelegate' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ResolutionDelegate ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Huawei.Hms.Api.ResolutionDelegate> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.RequestCode;
		}
#pragma warning restore 0169

		public virtual unsafe int RequestCode {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/method[@name='getRequestCode' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/method[@name='onBridgeActivityCreate' and count(parameter)=1 and parameter[1][@type='android.app.Activity']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/method[@name='onBridgeActivityDestroy' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/method[@name='onBridgeActivityResult' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='android.content.Intent']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/method[@name='onBridgeConfigurationChanged' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.hms.api']/class[@name='ResolutionDelegate']/method[@name='onKeyUp' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='android.view.KeyEvent']]"
